...
void timer_init(void)
{
	...
	/* Configura el Timer0 */
	rTCFG0 |= 0x000000ff; // ajusta el preescalado
	rTCFG1 |= 0x0000000f; // selecciona la entrada del mux que proporciona el reloj. La 00 corresponde a un divisor de 1/2.
	rTCNTB0 = 195312;// valor inicial de cuenta (la cuenta es descendente)
